...
#define HW_PWM_DEADTIME_NS		75.f		/* irf100p218 */
#define HW_PWM_BOOTSTRAP_TIME		100.f		/* UCC27211A  */
...
#define HW_ADC_VOLTAGE_R1		(470000.f + 330000.f)
#define HW_ADC_VOLTAGE_R2		27000.f
#define HW_ADC_VOLTAGE_BIAS_R3		470000.f
...
#define HW_ATS_PCB_RANGE		(3.3f / 0.0136f)
#define HW_ATS_PCB_T0		(2.633f / 3.3f)

#define HW_HAVE_ATS_ON_PCB
